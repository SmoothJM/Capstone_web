...
// user
use capstone
db.user.insert({email:'deng5945@uwlax',username:'Jianmu',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'deng594@uwlax',username:'Jianmu',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'deng59@uwlax',username:'Jianmu',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'deng5@uwlax',username:'Jianmu',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'deng@uwlax',username:'Jianmu',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'yali5945@uwlax',username:'Yali',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'yali594@uwlax',username:'Yali',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'yali59@uwlax',username:'Yali',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'yali5@uwlax',username:'Yali',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
db.user.insert({email:'yali@uwlax',username:'Yali',password:'202cb962ac59075b964b07152d234b70',status:0,role:0});
